...
val new_user_view : unit -> unit -> Html5_types.html Eliom_content.Html5.elt Lwt.t

val create_user_view : unit -> string * (string * string) -> Html5_types.html Eliom_content.Html5.elt Lwt.t
